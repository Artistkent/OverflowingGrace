"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[358],{5002:function(e,t,n){n.d(t,{ET:function(){return st},JU:function(){return iS},PL:function(){return i7},ad:function(){return ik},hJ:function(){return iC},oe:function(){return se},qs:function(){return ss}});var r,i,s,a,o=n(9279),l=n(2680),u=n(9053),h=n(3943),c=n(6552),d=n(4575);n(357);var f=n(6300).Buffer;let m="@firebase/firestore";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class eL{constructor(e){this.value=e}static empty(){return new eL({mapValue:{}})}field(e){if(e.isEmpty())return this.value;{let t=this.value;for(let n=0;n<e.length-1;++n)if(!eD(t=(t.mapValue.fields||{})[e.get(n)]))return null;return(t=(t.mapValue.fields||{})[e.lastSegment()])||null}}set(e,t){this.getFieldsMap(e.popLast())[e.lastSegment()]=eR(t)}setAll(e){let t=$.emptyPath(),n={},r=[];e.forEach((e,i)=>{if(!t.isImmediateParentOf(i)){let e=this.getFieldsMap(t);this.applyChanges(e,n,r),n={},r=[],t=i.popLast()}e?n[i.lastSegment()]=eR(e):r.push(i.lastSegment())});let i=this.getFieldsMap(t);this.applyChanges(i,n,r)}delete(e){let t=this.field(e.popLast());eD(t)&&t.mapValue.fields&&delete t.mapValue.fields[e.lastSegment()]}isEqual(e){return eE(this.value,e.value)}getFieldsMap(e){let t=this.value;t.mapValue.fields||(t.mapValue={fields:{}});for(let n=0;n<e.length;++n){let r=t.mapValue.fields[e.get(n)];eD(r)&&r.mapValue.fields||(r={mapValue:{fields:{}}},t.mapValue.fields[e.get(n)]=r),t=r}return t.mapValue.fields}applyChanges(e,t,n){for(let r of(ee(t,(t,n)=>e[t]=n),n))delete e[r]}clone(){return new eL(eR(this.value))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sr{constructor(e,t){this._firestore=e,this._commitHandler=t,this._mutations=[],this._committed=!1,this._dataReader=iB(e)}set(e,t,n){this._verifyNotCommitted();let r=si(e,this._firestore),i=i4(r.converter,t,n),s=iz(this._dataReader,"WriteBatch.set",r._key,i,null!==r.converter,n);return this._mutations.push(s.toMutation(r._key,tN.none())),this}update(e,t,n,...r){let i;this._verifyNotCommitted();let s=si(e,this._firestore);return i="string"==typeof(t=(0,h.m9)(t))||t instanceof ix?function(e,t,n,r,i,s){let a=e.Fu(1,t,n),o=[iH(t,r,n)],l=[i];if(s.length%2!=0)throw new S(C.INVALID_ARGUMENT,`Function ${t}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let e=0;e<s.length;e+=2)o.push(iH(t,s[e])),l.push(s[e+1]);let u=[],c=eL.empty();for(let e=o.length-1;e>=0;--e)if(!iJ(u,o[e])){let t=o[e],n=l[e];n=(0,h.m9)(n);let r=a.Su(t);if(n instanceof i$)u.push(t);else{let e=iK(n,r);null!=e&&(u.push(t),c.set(t,e))}}return new iF(c,new eo(u),a.fieldTransforms)}(this._dataReader,"WriteBatch.update",s._key,t,n,r):function(e,t,n,r){let i=e.Fu(1,t,n);ij("Data must be an object, but it was:",i,r);let s=[],a=eL.empty();return ee(r,(e,r)=>{let o=iY(t,e,n);r=(0,h.m9)(r);let l=i.Su(o);if(r instanceof i$)s.push(o);else{let e=iK(r,l);null!=e&&(s.push(o),a.set(o,e))}}),new iF(a,new eo(s),i.fieldTransforms)}(this._dataReader,"WriteBatch.update",s._key,t),this._mutations.push(i.toMutation(s._key,tN.exists(!0))),this}delete(e){this._verifyNotCommitted();let t=si(e,this._firestore);return this._mutations=this._mutations.concat(new tF(t._key,tN.none())),this}commit(){return this._verifyNotCommitted(),this._committed=!0,this._mutations.length>0?this._commitHandler(this._mutations):Promise.resolve()}_verifyNotCommitted(){if(this._committed)throw new S(C.FAILED_PRECONDITION,"A write batch can no longer be used after commit() has been called.")}}function si(e,t){if((e=(0,h.m9)(e)).firestore!==t)throw new S(C.INVALID_ARGUMENT,"Provided document reference is from a different Firestore instance.");return e}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
